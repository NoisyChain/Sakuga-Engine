...
namespace SakugaEngine
{
    public partial interface IDamage
    {
        ...
        void HitTrade(SakugaActor target, HitboxElement box, Vector2I contact);
        void ThrowDamage(SakugaActor target, HitboxElement box, Vector2I contact);
        void ThrowTrade();
        void HitboxClash(SakugaActor target, HitboxElement box, Vector2I contact);
        void ProjectileClash(SakugaActor target, HitboxElement box, Vector2I contact);
